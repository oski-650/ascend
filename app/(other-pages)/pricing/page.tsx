...
import FeatureDepthGraph from "@/components/other-pages/FeatureDepthGraph";

import { Metadata } from "next";
export const metadata: Metadata = {
  title: "Pricing | Ascend Web Solutions",
  description:
    "Transparent pricing for high‑converting websites, SEO, and digital solutions by Ascend Web Solutions. Built to scale with your business.",
};
              ...
              <VelocityMarquee className="marquee marquee-right--gsap muted-extra">
                <div className="marquee__toright">
                  ...
                  {Array.from({ length: 4 }).map((_, idx) => (
                    ...
                    >
                      <p className="marquee__text">Contact Us</p>
