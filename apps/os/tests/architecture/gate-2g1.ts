...
export const GATE_2G1: Record<string, GateEntry> = {
  ...
  "tests/db/production-2e-consumer-parity.test.ts": { evidence: "BLOCKED", phase: "db", why: "direct endpoint IPv6-only, unreachable", requires: ["ASCEND_DATABASE_URL", "ASCEND_DATABASE_URL_DIRECT"] },
  ...
  "tests/db/production-2e-raw-parity.test.ts": { evidence: "BLOCKED", phase: "db", why: "direct endpoint IPv6-only, unreachable", requires: ["ASCEND_DATABASE_URL_DIRECT"] },
  "tests/db/production-2e-source-flip.test.ts": { evidence: "BLOCKED", phase: "db", why: "direct endpoint IPv6-only, unreachable", requires: ["ASCEND_DATABASE_URL", "ASCEND_DATABASE_URL_DIRECT"] },
  ...
  "tests/db/production-app-login.test.ts": { evidence: "BLOCKED", phase: "db", why: "direct endpoint is IPv6-only and egress is down; re-probed, not assumed", requires: ["ASCEND_DATABASE_URL", "ASCEND_DATABASE_URL_DIRECT"] },
