          ...
          <div className="mxd-projects-masonry">
            <div className="container-fluid p-0">
              ...
              >
                ...
                {projects1.slice(0, 4).map((project) => (
                  <div
                  ...
                  >
                    <Link
                      ...
                      href={project.pageLink} // use pageLink from JSON
                      scroll={true}
                    >
                      <BackgroundParallax
                    ...
                    <div className="mxd-project-item__promo">
                      <div className="mxd-project-item__name">
                        <Link
                          ...
                          href={project.pageLink} // dynamic link
                        >
