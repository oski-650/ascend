                ...
                <div className="row g-0 d-flex">
                  ...
                  <div className="col-12 col-xl-6 mxd-values__item order-3 order-xl-3 mobile-reverse mxd-grid-item no-margin animate-card-2">
                    ...
                    <div className="mxd-values__descr has-top-list anim-uni-in-up">
                      ...
                      >
                         We are Ascend Web Solutions, a creative digital agency combining design, development, and strategy to help businesses stand out online. Our approach delivers websites that engage, convert, and elevate brands in the modern digital landscape.
                      </RevealText>
                    </div>
                  </div>
                </div>
