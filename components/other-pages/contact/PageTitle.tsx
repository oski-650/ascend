                ...
                <div className="mxd-block__content">
                  <div className="mxd-block__inner-headline loading__item">
                    ...
                    <a
                      ...
                      href="mailto:ascendweb1@gmail.com?subject=Message%20from%20your%20site"
                    >
                      <span className="btn-caption">ascendweb1</span>
                      <i className="ph-bold ph-arrow-up-right" />
                    </a>
                    <p className="inner-headline__text t-large t-bright loading__item">
                      Have questions? We’ve got answers. Explore how we work, what we offer, and what to expect when partnering with us. Need clarity on something specific? Just reach out.
                    </p>
                  </div>
                </div>
              </div>
